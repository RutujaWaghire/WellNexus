...
public class PractitionerService {
    ...
    public List<PractitionerDTO> getVerifiedPractitioners() {
        return practitionerRepository.findByVerified(true).stream()
                .map(this::convertToDTO)
                .collect(Collectors.toList());
    }
    
    public List<PractitionerDTO> getPractitionersBySpecialization(String specialization) {
    ...
    private PractitionerDTO convertToDTO(PractitionerProfile profile) {
